...
(function (ci01) {
    ...
    const rangeContainer = document.querySelector(".theme-range");
    const containerCalc = document.querySelector(".container-calc");
    const resultContainer = document.querySelector(".result-container");
    const buttonsActions = document.querySelectorAll(".del, .reset, .igual");
    const textHeader = document.querySelectorAll(".calc, .txt-theme");
    const numbersHeader = document.querySelector(".theme-color");
    const range = document.querySelector(".theme-range-input");
    let total = 0;
    let record = [];
    let currentOperator = "+";
